...
import LandAllocation from './pages/LandAllocation'; // Import Ranger component
  ...
  <React.StrictMode>
    ...
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path='landAllocation' element={<LandAllocation/>} /> {/* Render Ranger component for '/ranger' route */}
